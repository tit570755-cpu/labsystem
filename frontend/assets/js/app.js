...
if (!localStorage.getItem('labsystem_seeded')) {
    const defaultExams = [
        ...
        { id: 2, code: 'GLI01', name: 'Glicose em Jejum', category: 'BioquÃ­mica', price: 15.00 },
        { id: 3, code: 'COL01', name: 'Colesterol Total e FraÃ§Ãµes', category: 'BioquÃ­mica', price: 30.00 }
    ];
    
    const defaultPatients = [
        { id: 1, full_name: 'JoÃ£o Carlos Silva', cpf: '123.456.789-00', birth_date: '1985-05-12', phone: '(11) 98765-4321', created_at: new Date().toISOString() },
